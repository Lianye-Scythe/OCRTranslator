...
LIGHT_MATERIAL_SCHEME = {
    ...
    "secondary": "#475569",
    "on_secondary": "#ffffff",
    "field_selection": "#dbe7f6",
    "on_field_selection": "#0f172a",
    ...
    "hero_tonal_bg": "#eef3f9",
    "hero_tonal_fg": "#334155",
    "hero_tonal_border": "#a4b6ca",
    "hero_tonal_hover_bg": "#e6edf6",
    "hero_tonal_hover_fg": "#1e293b",
    "hero_tonal_hover_border": "#8ea4bd",
    "surface_dim": "#f8fafc",
    "surface": "#ffffff",
...
DARK_MATERIAL_SCHEME = {
    ...
    "secondary": "#A0A6B1",
    "on_secondary": "#121316",
    "field_selection": "#41516A",
    "on_field_selection": "#F3F6FA",
...
def _ui_role_tokens(scheme: dict[str, str]) -> dict[str, str]:
    return {
        ...
        "hero_tonal_bg": scheme.get("hero_tonal_bg", scheme["tertiary_container"]),
        "hero_tonal_fg": scheme.get("hero_tonal_fg", scheme["on_tertiary_container"]),
        "hero_tonal_border": scheme.get("hero_tonal_border", scheme["tertiary_border"]),
        "hero_tonal_hover_bg": scheme.get("hero_tonal_hover_bg", scheme["surface_container_high"]),
        "hero_tonal_hover_fg": scheme.get("hero_tonal_hover_fg", scheme["on_surface"]),
        "hero_tonal_hover_border": scheme.get("hero_tonal_hover_border", scheme["secondary_border"]),
        ...
        "field_focus_border": scheme.get("field_focus", scheme["primary_focus"]),
        "field_selection_bg": scheme.get("field_selection", scheme["primary_container"]),
        "field_selection_fg": scheme.get("on_field_selection", scheme["on_surface"]),
