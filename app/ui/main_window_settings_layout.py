...
class MainWindowSettingsLayoutMixin:
    def _build_settings_tab(self):
        ...
        self._build_profile_section(content_layout)
        self._build_quick_actions_section(content_layout)
        self._build_api_section(content_layout)
        self._build_reading_section(content_layout)
        self._build_prompt_section(content_layout)
    ...
    def _build_profile_section(self, content_layout):
    ...
    def _build_api_section(self, content_layout):
    ...
    def _build_reading_section(self, content_layout):
    ...
    def _build_prompt_section(self, content_layout):
