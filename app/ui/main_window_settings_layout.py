...
class MainWindowSettingsLayoutMixin:
    ...
    def _build_advanced_section(self, content_layout):
        ...
        self.debug_logging_hint_label = QLabel()
        self.debug_logging_hint_label.setObjectName("HintLabel")
        self.debug_logging_hint_label.setWordWrap(True)
        ...
        advanced_content_layout.addWidget(self.debug_logging_checkbox)
        advanced_content_layout.addWidget(self.debug_logging_hint_label)
    ...
    def _connect_settings_form_signals(self):
        ...
        self.debug_logging_checkbox.stateChanged.connect(self.on_form_input_changed)
