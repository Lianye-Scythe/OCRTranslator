...
class MainWindowLayoutMixin:
    def build_ui(self):
        ...
        for chip in (self.hotkey_chip, self.target_chip, self.mode_chip):
    ...
    def _build_settings_tab(self):
        ...
        self.hotkey_record_button = self.create_button(self.start_hotkey_recording, accent=False, compact=True)
        ...
        reading_grid.addWidget(self.create_field_block(self.overlay_font_label, self.overlay_font_combo), 2, 0)
        reading_grid.addWidget(self.create_field_block(self.overlay_font_size_label, self.overlay_font_size_spin), 2, 1)
        reading_grid.addWidget(self.create_field_block(self.mode_label, self.mode_combo), 3, 0, 1, 2)
    ...
    def apply_language(self):
        ...
        self.hotkey_record_button.setText(self.tr("record_hotkey") if not getattr(self, "hotkey_recording", False) else self.tr("recording_hotkey"))
