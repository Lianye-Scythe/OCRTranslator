...
Prefer uploading the versioned archive first. The file name should include the project name, version, and platform, for example: `OCRTranslator-v1.0.6-windows-x64.zip`, and attach a companion `SHA256SUMS.txt` file for manual verification.
